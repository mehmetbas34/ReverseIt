...
2. Open **Unity Hub** and create a new **2D** project (or open an existing one).
3. In the Unity Editor top menu, navigate to `Assets > Import Package > Custom Package...`
4. Find and select the downloaded `.unitypackage` file.
